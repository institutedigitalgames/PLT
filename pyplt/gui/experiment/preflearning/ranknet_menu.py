...
class RankNetMenu(tk.Frame):
    ...
    def __init__(self, parent, on_resize_fn):
        ...
        self._output_activation_function = tk.StringVar(value="LINEAR")
        self._learn_rate = tk.DoubleVar(value=0.001)
        self._epochs = tk.IntVar(value=100)
        self._batch_size = tk.IntVar(value=32)
        ...
        self._add_entry_param(bp_params, "Batch size", self._batch_size, 0, ParamType.INT.name)

        self._add_entry_param(bp_params, "Learning rate", self._learn_rate, 1, ParamType.FLOAT.name)
        ...
        self._add_entry_param(bp_term_params, "Epochs", self._epochs, 0, ParamType.INT.name)
    ...
    def get_params(self):
        ...
        params_dict = {'ann_topology': ann_topology,
                       ...
                       'hidden_activation_functions': activation_fns,
